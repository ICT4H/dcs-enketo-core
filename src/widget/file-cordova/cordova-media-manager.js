...
var cordovaMediaManager = (function($) {
    ...
    var init, captureAndMove, copyFromGallery, fileNameToURL, fileNameToFile, fileNameToReadFileAndType,
        _fsReady,
    ...
    fileNameToReadFileAndType = function(fileName, onSuccess) {
    ...
    return {
        ...
        fileNameToReadFileAndType: fileNameToReadFileAndType
    };
